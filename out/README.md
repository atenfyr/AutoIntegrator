...
## Manual Installation
### UE4SS
First, install UE4SS (commit 47a0847 or later, which at this point in time is an experimental build available here: https://github.com/UE4SS-RE/RE-UE4SS/releases/download/cmake-experimental/UE4SS_v3.0.1-707-g47a0847.zip). Simply drag the "mod" folder within this .zip file into the folder you are using for UE4SS mods. This is typically the "Astro\Binaries\Win64\Mods" folder within the game installation, meaning you will then have a folder at "Astro\Binaries\Win64\Mods\mod". You can then install your AstroModLoader mods into the "Astro\Content\Paks\LogicMods" directory.
